...
**FIRST**: Use the Read tool to load `~/.codex/plugins/codex-hud/config.json` if it exists.
...
- options: **ONLY items that are ON in the chosen preset** (max 4)
  ...
  - "Config counts" - 2 AGENTS.md | 4 rules
...
Write to `~/.codex/plugins/codex-hud/config.json`.
